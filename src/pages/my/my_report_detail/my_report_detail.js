    ...
    render() {
        ...
        return (
            <div className='my_report_detail'>
                <div className='nav'>
                    <h4>体检报告单</h4>
                    <h5>{item.checkinCode} {item.deptName}</h5>

                </div>
                <div className='nav-title'>
                    姓名: {item.patientName}<span>{item.sex}</span><span>{item.age}</span>
                </div>
                ...
                <div className='main'>
                    ...
                    <div className='main-title'>
                        <h4 className='yisheng'>总检医生:DL</h4>
                    </div>


                    <Accordion className="my-accordion">
                        <Accordion.Panel header="一般项目">
                            {/*一般项目*/}
                            <div className='main-title'>
                                ...
                                <div className="mui-card-footer" style={{background: '#fff', margin: '10px 0'}}>
                                    <span style={{fontWeight: 600}}>小结:无异常项</span>
                                    <span style={{fontWeight: 600}}>主治医师: DL</span>
                                </div>
                            </div>
                        </Accordion.Panel>
                        <Accordion.Panel header="内科" className="pad">
                            {/*内科*/}
                            <div className='main-title'>
                                <div className="mui-card-footer" style={{background: '#fff', margin: '10px 0'}}>
                                    <span>项目名称</span>
                        ...
                        <Accordion.Panel header="彩超室" className="pad">
                            {/*彩超*/}
                            <div className='main-title'>
                                <div className="mui-card-footer" style={{background: '#fff', margin: '10px 0'}}>
                                    <span>项目名称</span>
                    ...
                    <div className="main-title">
                        <h4 className='yisheng' style={{display:'flex',justifyContent:'space-between'}}>
                            <span>总检医生:DL</span>
                            <span>报告日期: {item.checkinDay}</span>
                        </h4>
                    </div>
